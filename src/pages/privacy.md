...
- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Arrosyid.id
...
- **Website** refers to AstroWind, accessible from [https://arrosyid.id](https://arrosyid.id)
